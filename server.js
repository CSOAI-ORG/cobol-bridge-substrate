 ...
 * - cobol.transform.records, cobol.analyze.transactions, cobol.analyze.jobs,
 *   cobol.discover.copybooks, cobol.transform.encoding (cobol.* — Core Legacy Tools)
 * - bridge.output.payments, bridge.validate.encryption, bridge.validate.compliance,
 *   cobol.discover.programs, bridge.output.interface, bridge.output.tests (bridge.* — Platform Tools)
 *
...
app.get('/', (req, res) => {
  res.json({
    ...
    tools: [
      'cobol.transform.records', 'cobol.analyze.transactions', 'cobol.analyze.jobs',
      'cobol.discover.copybooks', 'cobol.transform.encoding', 'bridge.output.payments',
      'bridge.validate.encryption', 'bridge.validate.compliance', 'cobol.discover.programs',
      'bridge.output.interface', 'bridge.output.tests'
    ],
